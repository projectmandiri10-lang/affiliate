...
<body class="bg-slate-50 min-h-screen">
    <main class="max-w-6xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        <header class="flex items-center justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-slate-800">Galeri Gambar Upload</h1>
                <p class="text-sm text-slate-500">Klik preview untuk lihat halaman pin (dengan countdown & caption).</p>
            </div>
    ...
    (function(){
        ...
        async function deletePin(pinId, btn, statusEl) {
            ...
            var ok = confirm("Hapus pin ini?\nPreview link akan 404 dan gambar di hosting akan dihapus.");
            if (!ok) return;
