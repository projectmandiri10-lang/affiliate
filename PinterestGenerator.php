...
HARAP HASILKAN OUTPUT DALAM FORMAT JSON SAJA DENGAN STRUKTUR INI:
{
    ...
    "pinterest_description": "String (7-15 kata, tanpa hashtag)",
...
2. DESKRIPSI:
    - Panjang WAJIB 7-15 kata (bukan karakter).
    - Harus 1 kalimat singkat, informatif, dan natural.
    - Tidak boleh mengandung hashtag (#) dan tidak boleh ada line break.
    - Bahasa Indonesia.
