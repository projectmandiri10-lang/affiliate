    ...
    <main class="max-w-4xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        <header class="flex items-center justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500">Update the copy/keywords, then pin using the preview page.</p>
            </div>
            <div class="flex gap-2">
                <a href="pins.php" class="px-4 py-2 rounded-lg bg-white border border-slate-200 text-slate-700 hover:bg-slate-100 transition text-sm font-semibold">Gallery</a>
        ...
        <section class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-white border border-slate-200 rounded-xl overflow-hidden">
                ...
                <?php else: ?>
                    <div class="p-6 text-slate-600">No image available.</div>
                <?php endif; ?>
            ...
            <form method="post" class="bg-white border border-slate-200 rounded-xl p-5 space-y-4">
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-1">Pinterest Title</label>
                ...
                <div>
                    ...
                    <p class="text-xs text-slate-500 mt-1">Saved with a max of 15 words. Hashtags are added automatically on the preview page / caption copy.</p>
                </div>

                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-1">Keywords (comma or new line separated)</label>
                ...
                <div>
                    <label class="block text-sm font-semibold text-slate-700 mb-1">ClickBank HopLink</label>
                ...
                <button class="w-full bg-red-600 hover:bg-red-700 text-white font-semibold py-3 rounded-lg transition">Save</button>
            </form>
        </section>
    </main>
