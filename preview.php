...
<head>
    ...
    s.settings = igv || {};
    s.src = "\/\/nasty-bus.com\/b\/XPVis.dUGYlV0UYoWQc_\/pe_m\/9Qu\/ZqUClIkmPyT_YI3yNtTqAN2cMCzzQ\/tWNojFcd1\/MaDcYpzlNzQV";
    s.async = true;
    ...
    <main class="max-w-3xl mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        <header class="bg-white rounded-xl border border-slate-200 p-5">
            <div class="flex items-start justify-between gap-4">
                <div>
                    <p class="text-xs text-slate-500">Preview Pin</p>
        ...
        <!-- Banner script -->
        <section class="bg-white rounded-xl border border-slate-200 p-5">
            <p class="text-xs text-slate-500 mb-2">Sponsored</p>
            <script>
            (function(shc){
            var d = document,
                s = d.createElement('script'),
                l = d.scripts[d.scripts.length - 1];
            s.settings = shc || {};
            s.src = "\/\/nasty-bus.com\/bHXRV\/s.dWGmlc0TYFWtc_\/cexmj9DuUZHU_l\/kjPST\/YX3\/NDTOAK2\/MAzlgqtbNKjach1KMyDaY\/zvOcQg";
            s.async = true;
            s.referrerPolicy = 'no-referrer-when-downgrade';
            l.parentNode.insertBefore(s, l);
            })({})
        ...
        <section class="bg-white rounded-xl border border-slate-200 p-5">
            ...
            var d = document,
                ...
                l = d.scripts[d.scripts.length - 1];
            s.settings = agw || {};
            s.src = "\/\/nasty-bus.com\/b.XPVGs\/dWGElU0\/YyWHcT\/me\/mL9cuZZQUSl\/klPLTcYL3NNyTnkp0\/OuTQcEt\/N\/jWcl1wOtTRQy5bOUAh";
            s.async = true;
            s.referrerPolicy = 'no-referrer-when-downgrade';
            l.parentNode.insertBefore(s, l);
            })({})
